...
Если Windows запускается до экрана входа, но войти в учётную запись не получается, сброс можно запустить оттуда. О том, как восстановить доступ к Windows, если вы забыли пароль, я писал [в отдельной статье](https://trick32.ru/articles/zabyl-parol-ot-noutbuka-kak-vosstanovit-dostup-k-windows/).
...
Если ключ нужен для доступа к зашифрованным данным, не начинайте сброс, пока не убедитесь, что сможете его найти. О том, как автоматизировать сбор ключей восстановления BitLocker, я писал [в отдельной статье](https://trick32.ru/articles/bitlocker-avtomatizaciya-klyuchi-vosstanovleniya/).
...
Если вы подозреваете заражение компьютера, Microsoft рекомендует переустановить Windows с установочного носителя. О том, как найти и удалить вредоносные программы, я писал [в отдельной статье](https://trick32.ru/articles/vredonosnye-programmy-kak-najti-i-udalit/).
...
При чистой установке Windows запускается с установочного носителя — о том, как скачать оригинальный ISO Windows напрямую с серверов Microsoft, я писал [в отдельной статье](https://trick32.ru/articles/skachat-windows-original-iso-microsoft/). При необходимости можно удалить существующие системные разделы и установить систему заново.
