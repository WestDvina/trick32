...
draft: false
images: ["/og/windows-11-26h2-kak-izbezhat-problem-pri-obnovlenii.jpg"]
---
...
Формально Windows 11 [требует от 64 ГБ](/articles/skolko-mesta-zanyimaet-windows-11-realnye-cifry/) под систему, но для обновления нужно свободное место под загрузку, распаковку и временные файлы. На 24H2/25H2 это не гигабайты образа, но без запаса установка всё равно упрётся.
...
Если лимитное включено специально для экономии трафика, сначала разберитесь, кто его тратит в фоне — [фоновые приложения, которые жрут Wi-Fi](/articles/fonovye-prilozheniya-zhrut-wi-fi-kak-ostanovit/) — а потом уже отключайте лимит для 26H2.
