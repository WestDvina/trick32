...
Microsoft определяет страну по IP-адресу. Пользователи из России и Беларуси под запретом и загрузка ISO напрямую с сайта корпорации или создание загрузочной флешки с помощью Media Creation Tool блокируются. VPN в данном случае не помогает: компания научилась вычислять и отсеивать смену IP.
